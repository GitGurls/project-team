...
// //           className="border p-2 rounded mb-6 w-72"
// //         />
...
// //             <div id="todo" className="bg-white p-4 rounded-lg shadow">
...
// //             <div id="in-progress" className="bg-white p-4 rounded-lg shadow">
...
// //             <div id="done" className="bg-white p-4 rounded-lg shadow">
...
// //         value={search}
// //         onChange={(e) => setSearch(e.target.value)}
// //         className="border border-gray-300 p-2 rounded-lg mb-8 w-72 focus:outline-none focus:ring-2 focus:ring-blue-500"
// //       />
...
// //           <div
// //             id="todo"
// //             className="backdrop-blur-lg bg-white/60 p-5 rounded-xl shadow-lg border border-white/30"
// //           >
