  ...
  return (
    <>
      ...
      <div style={{
        ...
        <div style={{ position: "fixed", bottom: -80, left: -80, width: 300, height: 300, borderRadius: "50%", background: "radial-gradient(circle, rgba(139,92,246,0.07) 0%, transparent 70%)", pointerEvents: "none" }} />
        ...
        <div style={{
          ...
          <h2 style={{ fontFamily: "'Syne', sans-serif", fontSize: 24, fontWeight: 800, color: "#111827", marginBottom: 6 }}>Welcome back</h2>
          <p style={{ fontSize: 13, color: "#9ca3af", marginBottom: 28 }}>Sign in to continue to your workspace</p>
          ...
          <p style={{ textAlign: "center", marginTop: 20, fontSize: 13, color: "#9ca3af" }}>
            ...
            <a href="/register" className="tf-link" style={{ color: "#6366f1", fontWeight: 600, textDecoration: "none", transition: "color 0.15s" }}>
              Create one
            </a>
          </p>
        </div>
